...
describe('calculateAverage', () => {
  ...
  it('should calculate the average of an array with a single argument', () => {
    expect(calculateAverage([1])).toBe(1)
  })
  it('should calculate the average of an array with two arguments', () => {
    expect(calculateAverage([1, 2])).toBe(1.5)
  })
  it('should calculate the average of an array with three arguments', () => {
